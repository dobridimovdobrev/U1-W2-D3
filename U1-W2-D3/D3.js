...
console.log("Prima: ", charactersNames.length);
...
console.log(`È nato nell'anno ${randomCharacter.birth_year} ed è di genere ${randomCharacter.gender}.`);
